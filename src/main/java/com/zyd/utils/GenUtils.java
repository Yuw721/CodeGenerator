...
import com.zyd.entity.ColumnEntity;
import com.zyd.entity.TableEntity;
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("list.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" +
                    File.separator + File.separator + className.substring(0, 1).toLowerCase() + className.substring(1) + ".vue";
        }

        if (template.contains("edit.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" +
                    File.separator + File.separator + className.substring(0, 1).toLowerCase() + className.substring(1) + "Lssue.vue";
        }
